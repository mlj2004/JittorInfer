...
static void llama_sampler_grammar_accept_impl(struct llama_sampler * smpl, llama_token /* unused */) {
    auto * ctx = (llama_sampler_grammar *) smpl->ctx;
    GGML_ASSERT(!ctx->grammar);
}

static void llama_sampler_grammar_apply(struct llama_sampler * smpl, llama_token_data_array * /* unused */) {
    auto * ctx = (llama_sampler_grammar *) smpl->ctx;
    GGML_ASSERT(!ctx->grammar);
}
...
static struct llama_sampler * llama_sampler_grammar_clone(const struct llama_sampler * /*unused*/) {
    GGML_ABORT("llama_sampler_grammar_clone not implemented");
    return nullptr;
}
...
static struct llama_sampler * llama_sampler_init_grammar_impl(const struct llama_vocab * vocab,
                                                              const char * grammar_str, const char * /* unused */,
                                                              bool /* unused */, const char ** /* unused */,
                                                              size_t /* unused */, const llama_token * /* unused */,
                                                              size_t /* unused */) {
    auto * ctx = new llama_sampler_grammar;

    if (grammar_str != nullptr && grammar_str[0] != '\0') {
        GGML_ABORT("grammar_lazy not implemented");
    } else {
        *ctx = {
            /* .vocab        = */ vocab,
            /* .grammar_str  = */ {},
...
static struct llama_sampler * llama_sampler_top_k_clone(const struct llama_sampler * /* unused */) {
    GGML_ABORT("llama_sampler_top_k_clone not implemented");
    return nullptr;
}
...
static struct llama_sampler * llama_sampler_xtc_clone(const struct llama_sampler * /* unused */) {
    GGML_ABORT("llama_sampler_xtc_clone not implemented");
    return nullptr;
}
...
static struct llama_sampler * llama_sampler_dry_clone(const struct llama_sampler * /* unused */) {
    GGML_ABORT("llama_sampler_dry_clone not implemented");
    return nullptr;
}
...
struct llama_sampler * llama_sampler_init_dry(const struct llama_vocab * vocab, int32_t n_ctx_train,
...
static struct llama_sampler * llama_sampler_penalties_clone(const struct llama_sampler * /*unused*/) {
    GGML_ABORT("llama_sampler_penalties_clone not implemented");
    return nullptr;
}
...
static struct llama_sampler * llama_sampler_chain_clone(const struct llama_sampler * /*unused*/) {
    GGML_ABORT("llama_sampler_chain_clone not implemented");
    return nullptr;
}
