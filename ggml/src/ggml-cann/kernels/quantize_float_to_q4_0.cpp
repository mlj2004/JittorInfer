...
extern "C" __global__ __aicore__ void ascendc_quantize_f32_to_q4_0(
    ...
    // let following test cases can continue run, here just print error
    // information. Of Cource the test case that call this operator is failed.
   ...
   public:
    ...
    __aicore__ inline void init(GM_ADDR input, GM_ADDR output,
        ...
        scale_gm.SetGlobalBuffer(
            (__gm__ half *)(output + scale_offset +
    ...
    __aicore__ inline half calculate_group(int64_t row, int64_t group) {
        ...
        const int64_t output_offset =
            (i1 * output_stride[1] + i2 * output_stride[2] +
