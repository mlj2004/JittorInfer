...
#define BUFFER_NUM 2
const int64_t SUPPORTED_MAX_DIM =
    65535;  // currently the limit of max block dim supportted by dup kernel is
            // 65535template <typename SRC_T, typename DST_T>
...
extern "C" __global__ __aicore__ void ascendc_dup_by_rows_fp16(
    GM_ADDR src_gm, GM_ADDR dst_gm, GM_ADDR input_ne_gm, GM_ADDR input_nb_gm,
